...
BOT_TOKEN = "8560529789:AAGIuisrEwTQbEk0mFy90kFLbD5Kb5ZGpks"
...
PLAYERS_DB = "userss.json"
LEAGUE_DB = "leaguezs.json"
...
async def start(client, message):
    ...
    try:
        ...
        if (
            channel.status in ["left", "kicked"]
            or
            chat.status in ["left", "kicked"]
        ):
